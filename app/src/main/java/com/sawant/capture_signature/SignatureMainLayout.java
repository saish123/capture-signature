...
public class SignatureMainLayout extends LinearLayout implements OnClickListener {
    ...
    private LinearLayout buttonsLayout() {
        ...
        View child = View.inflate(context, R.layout.activity_main, null);
       ...
       /* LinearLayout linearLayout = new LinearLayout(this.getContext());
        ...
        Button saveBtn = child.findViewById(R.id.saveButton);
        Button clearBtn = child.findViewById(R.id.clearButton);
        LinearLayout mainLinearLayout = (LinearLayout) child.findViewById(R.id.mainLinearLayout);
